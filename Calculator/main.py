...
btnBackspace.grid(row=1,column=0,padx=1)
...
btnclear.grid(row=1,column=1,padx=1)
...
btnClearAll.grid(row=1,column=2,padx=1)

btnPM= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text=chr(177),bg='cadetblue',command=added_value.mathsPM)
btnPM.grid(row=1,column=3,padx=1)

btnsq= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="√",command=added_value.squared)
btnsq.grid(row=2,column=0,padx=1)

btnCos= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="Cos",command=added_value.cos)
btnCos.grid(row=2,column=1,padx=1)

btntan= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="Tan",command=added_value.tan)
btntan.grid(row=2,column=2,padx=1)

btnsin= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="Sin",bg='cadet blue',command=added_value.sin)
btnsin.grid(row=2,column=3,padx=1)


btnAdd= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="+",bg='cadetblue',command=lambda:added_value.operation("add"))
btnAdd.grid(row=3,column=3,padx=1)

btnSub= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="-",bg='cadetblue',command=lambda:added_value.operation("sub"))
btnSub.grid(row=4,column=3,padx=1)

btnMult= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="*",bg='cadetblue',command=lambda:added_value.operation("multi"))
btnMult.grid(row=5,column=3,padx=1)

btnDiv= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text=chr(247),bg='cadetblue',command=lambda:added_value.operation("divide"))
btnDiv.grid(row=6,column=3,padx=2)

btnZero= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="0",bg='cadetblue',command=lambda:added_value.operation(0))
btnZero.grid(row=6,column=0,padx=1)

btnDot= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text=".",bg='cadetblue',command=lambda:added_value.operation("."))
btnDot.grid(row=6,column=1,padx=1)

btnEquals= Button(MainFrame,width=6,height=2,font=('arial',16,'bold'),bd=4,text="=",bg='cadetblue',command=added_value.sum_of_total)
btnEquals.grid(row=6,column=2,padx=1)
